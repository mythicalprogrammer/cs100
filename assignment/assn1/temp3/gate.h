...
class gate
{
  ...
  */
  ...
  private:
   ...
   bool internal; ///< Flag to say this gate is depending on another gate's output
   bool last_gate; ///< Flag to say this gate is the last gate 
   bool dirtyBit; ///< The dirty bit (like in a cache: a validity bit)
};
