...
Gate::Gate() : gateName(""), wireZero(0), wireOne(0), wireOut(0), disable(false),traversed(false),calculated(false)
{
}

Gate::Gate(const Gate& temp) : gateName(""), wireZero(0), wireOne(0),
			       wireOut(0),disable(false), traversed(false),calculated(false)
{
