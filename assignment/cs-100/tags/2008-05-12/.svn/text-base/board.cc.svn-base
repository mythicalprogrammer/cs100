...
*/
    /*Pre-condition DBC*/
    REQUIRE(a < inputWireVector.size());
    REQUIRE(inputWireVector[a]->get_type()=="internal" or inputWireVector[a]->get_type()=="external");
...
*/
      /*Pre-condition DBC*/
      REQUIRE(a < inputWireVector.size());
      REQUIRE(inputWireVector[a]->get_name()=="");
...
*/
    /*Pre-condition DBC*/
    REQUIRE(count < inputWireVector.size());
    REQUIRE(inputWireVector[count]->get_type()=="internal" or inputWireVector[a]->get_type()=="external");
